            ...
            if (isset($_POST['grado-formacion']) && is_array($_POST['grado-formacion'])) {
                foreach ($_POST['grado-formacion'] as $index => $grado) {
                    ...
                    if (!$conn->exec($sqlDocument)) {
                        throw new Exception("Error al insertar documento en la posici��n $index.");
                    }
                }
            }
